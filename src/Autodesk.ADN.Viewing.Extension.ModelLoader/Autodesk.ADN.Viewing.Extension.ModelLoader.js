...
Autodesk.ADN.Viewing.Extension.ModelLoader = function(viewer, options) {
    ...
    var API = {
                        ...
                        () => {
                            Autodesk.Viewing.Document.load(
                                ...
                                document => {
                                    ...
                                    var got2d =
                                        geometryItems2d &&
                                        geometryItems2d.length > 0;
                                    var got3d =
                                        geometryItems3d &&
                                        geometryItems3d.length > 0;
                                ...
                                err => {
                                    ...
                                    switch (err) {
                                        ...
                                        case 2: //BAD_DATA
                                            console.log(
                                                "Bad data (corrupted or malformed) " +
                                                    "was encountered."
                                            );
                                            break;
                                        ...
                                        case 6: //NETWORK_SERVER_ERROR
                                            console.log(
                                                "A server error was returned when " +
                                        ...
                                        case 7: //NETWORK_UNHANDLED_RESPONSE_CODE
                                            console.log(
                                                "An unhandled response code was " +
        ...
        transformModel: function(model, transform) {
            ...
            return new Promise(async (resolve, reject) => {
                var fragCount = model.getFragmentList().fragments.fragId2dbId
                    .length;
    ...
    this.load = function() {
        ...
        var modules = ["inspireTree", "inspireTreeCss", "modelLoaderCss"];
    ...
    var ModelLoaderPanel = function(
      ...
      <div class="container">
        ...
        _thisPanel.setVisible = function(show) {
            ...
            Autodesk.Viewing.UI.DockingPanel.prototype.setVisible.call(
                this,
                show
            );
        };
...
Autodesk.ADN.Viewing.Extension.ModelLoader.prototype = Object.create(
